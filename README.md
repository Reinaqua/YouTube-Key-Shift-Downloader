...
由於`ytdownloader.exe`的升降Key功能是為on vocal設計，而`audio_replacer.exe`的升降Key功能是為off vocal設計，因此在使用yt downloader調升降Key後若再使用UVR5分離人聲跟伴奏可能會使分離效果變差，如果最終要變成off vocal版則推薦先下載原key版本影片檔後用audio replacer結合時再設定升降KEY會比較合適

**如何順利開啟軟體？**
1. 在藍色的警告視窗中，點擊文字 **「其他資訊」**。
2. 接著點擊右下方出現的 **「仍要執行」** 按鈕，即可順利啟動。

示範影片:
https://youtu.be/j6eQO7-tjkI?si=6kxp_7rtcdcBPNf6
